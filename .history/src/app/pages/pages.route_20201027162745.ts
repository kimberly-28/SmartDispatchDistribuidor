...
import { OffertProductsComponent } from './offert-products/offert-products.component';
...
const pagesRoutes: Routes = [

  {
    ...
    children: [
      ...
      { path: "productsdetails/:id", component: OffertProductsComponent , canActivate: [AuthguardGuard]  },
