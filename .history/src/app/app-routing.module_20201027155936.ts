...
const routes: Routes = [
      ...
      { path: "Buy-Car",
        ...
        { path: "Offert-Products",
        loadChildren: () => import('./pages/        { path: "Offert-Products",
        loadChildren: () => import('./pages/offert-products/offert-products.module').then(m => m.OffertProductsModule)},/offert-products.module').then(m => m.OffertProductsModule)},
      ];
